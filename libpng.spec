...
%prep
%setup -q -n libpng-1.6.36
%patch1 -p1
pushd ..
cp -a libpng-1.6.36 build32
popd
pushd ..
cp -a libpng-1.6.36 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1549301718
export AR=gcc-ar
...
/usr/lib64/haswell/libpng16.so.16.36.0
